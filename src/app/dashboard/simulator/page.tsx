        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100">
              Payment Failure & Reliability Simulator
            </h1>
            <Badge variant="outline">Phase 9</Badge>
          </div>
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
            Simulate duplicate webhooks, network timeouts, invalid signatures, and Inngest retry workflows.
          </p>
        </div>
      </div>
        ...
        <CardContent className="p-12 text-center flex flex-col items-center justify-center space-y-4">
          ...
          <div className="space-y-1 max-w-md">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400">
              Interactive test controls for race conditions, idempotency key replays, and simulated downtime will activate in Phase 9.
            </p>
          </div>
        </CardContent>
      </Card>
